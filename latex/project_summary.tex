...
The direct fix is to expose the network, during training, to states reached by \emph{its own}
imperfect steps, not only the idealized line. A short, gradient-tracked rollout from $x_0$
using the model's own predictions at each step,
\begin{equation}
